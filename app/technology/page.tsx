                ...
                <div className="flex items-start space-x-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-700 text-lg mb-4">
                      Multi-signature wallet managing PAXG/XAUT collateral with automated USDC borrowing against gold
                      reserves.
                    </p>
                    <div className="grid md:grid-cols-2 gap-4">
                      <div className="bg-amber-100/50 rounded-lg p-4">
                        ...
                        <ul className="text-sm text-amber-700 space-y-1">
                          ...
                          <li>• Automated DeFi lending integration</li>
                          <li>• Real-time collateralization monitoring</li>
              ...
              <CardContent className="p-8">
                <div className="flex items-start space-x-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-700 text-lg mb-4">
                      Semi-fungible tokens representing DAO's claims on coffee batches, issued against USDC loans and
                      sold to repay lending protocols.
                    </p>
                    <div className="grid md:grid-cols-2 gap-4">
                      ...
                      <div className="bg-green-100/50 rounded-lg p-4">
                        ...
                        <ul className="text-sm text-green-700 space-y-1">
                          <li>• Loan collateral representation</li>
                          <li>• Supply chain tracking</li>
                          <li>• Quality verification</li>
                          <li>• Automated loan repayments</li>
                        </ul>
                      </div>
                    </div>
                  </div>
