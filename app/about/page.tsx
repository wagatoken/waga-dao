          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-emerald-200 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 hover:rotate-1 group">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-2xl font-bold text-emerald-700 mb-4">Sustainable Reflow</h3>
                <p className="text-gray-600">
                  Loans → deployment → inventory tokens → sales → loan repayment → annual contributions → regional
                  scaling
                </p>
              </CardContent>
            </Card>
