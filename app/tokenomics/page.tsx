    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-green-50 to-emerald-100 overflow-x-hidden">
      ...
      <section className="pt-32 pb-20 px-6 relative">
        <div className="container mx-auto text-center max-w-4xl">
          ...
          <p className="text-xl text-gray-700 mb-12 max-w-3xl mx-auto leading-relaxed">
            ...
            $30M gold treasury. This gold reserve enables sustainable USDC loans to cooperatives at 65% LTV, providing
              ...
              <CardContent className="p-8">
                ...
                <div className="mt-4 p-3 bg-green-50 rounded-lg">
                  <p className="text-xs text-green-800">
                    <strong>Utility Only:</strong> Minted only to cover DAO loan values to cooperatives for inventory
                    management.
                  </p>
                </div>
              </CardContent>
              ...
              <CardContent className="p-8">
                ...
                <ul className="space-y-3 text-gray-700">
                  ...
                  <li className="flex items-center">
                    <TrendingUp className="h-4 w-4 text-green-600 mr-3" />
                    <span>
                      <strong>Sustainable Loans:</strong> Reusable collateral for multiple cycles
                    </span>
                  </li>
                  <li className="flex items-center">
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              DAO's $30M gold treasury enables $19.5M USDC loans (65% LTV) - allocated as follows:
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <Card className="bg-white/80 backdrop-blur-sm border-green-200 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 group">
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-gray-600">
                    Direct USDC loans to farmers for infrastructure and operations ($13.65M)
                  </p>
                </CardContent>
              </Card>
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-blue-200 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 mb-6">USDC loans from gold collateral</p>
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-white/60 via-green-50/60 to-emerald-100/80 relative">
        ...
        <div className="container mx-auto max-w-6xl relative">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-amber-700 to-green-700 bg-clip-text text-transparent">
              Gold-Collateralized Lending
            </h2>
            <p className="text-xl text-gray-600">Sustainable capital deployment through DeFi protocols</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-green-200 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 hover:-rotate-1 group">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-2xl font-bold text-green-700 mb-4">DeFi Borrowing</h3>
                <p className="text-gray-600 mb-4">
                  Borrow $19.5M USDC against $30M gold at 65% LTV ratio through established DeFi lending protocols
                </p>
                <div className="text-sm text-green-600 font-semibold">$19.5M USDC Capacity</div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-emerald-200 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 hover:rotate-1 group">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-2xl font-bold text-emerald-700 mb-4">Cooperative Loans</h3>
                <p className="text-gray-600 mb-4">
                  Deploy USDC to cooperatives in exchange for tokenized claims on finished coffee products
                </p>
          ...
          <div className="mt-12 text-center">
            <Card className="bg-white/80 backdrop-blur-sm border-blue-200 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 max-w-4xl mx-auto">
              <CardContent className="p-8">
                <h3 className="text-2xl font-bold text-blue-700 mb-4">Sustainable Reflow Model</h3>
                <div className="grid md:grid-cols-3 gap-6 text-left">
                  <div>
                    <h4 className="font-semibold text-blue-800 mb-2">Phase 1: Deployment</h4>
                    <ul className="text-sm text-blue-700 space-y-1">
                      <li>• Gold collateral secures USDC loans</li>
                      <li>• USDC deployed to cooperatives</li>
                  ...
                  <div>
                    <h4 className="font-semibold text-blue-800 mb-2">Phase 3: Repayment & Scale</h4>
                    <ul className="text-sm text-blue-700 space-y-1">
                      <li>• DAO sells inventory tokens to repay loans</li>
                      <li>• Cooperatives make annual gold contributions</li>
                ...
                <div className="grid md:grid-cols-2 gap-6 text-left">
                  <div>
                    ...
                    <ul className="text-sm text-blue-700 space-y-1">
                      ...
                      <li>• USDC loan deployment to cooperatives</li>
