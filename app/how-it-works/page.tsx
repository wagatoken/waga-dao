                ...
                <div className="flex items-start space-x-6">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center mb-4">
                      ...
                      <h3 className="text-2xl font-bold text-purple-700">Loan Repayment & Scaling</h3>
                    </div>
                    <p className="text-gray-700 text-lg mb-4">
                      DAO sells inventory tokens representing finished coffee to repay USDC loans. Cooperatives make
                      annual contributions to the gold treasury, enabling expansion to new regions.
                    </p>
                    <div className="flex items-center text-purple-600">
                      <RefreshCw className="h-4 w-4 mr-2" />
                      <span className="text-sm">Sustainable loan repayment cycle</span>
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <CardContent className="p-12">
              <div className="grid md:grid-cols-3 gap-8 items-center">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600">USDC loans for infrastructure</p>
                </div>
              ...
              <div className="mt-8 text-center">
                <p className="text-gray-700 text-lg">
                  <span className="font-semibold text-amber-700">Gold Collateral</span> →
                  <span className="font-semibold text-green-700 mx-2">USDC Loans</span> →
                  <span className="font-semibold text-emerald-700">Sustainable Returns</span>
                </p>
              </div>
            </CardContent>
          </Card>
